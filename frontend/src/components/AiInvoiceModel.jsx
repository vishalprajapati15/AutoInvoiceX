...
const AiInvoiceModel = ({ open, onClose, onGenerate, initialText = "" }) => {
  ...
  async function handleGenerateClick() {
    ...
    try {
      ...
      const msg = err && (err.messaage || (typeof err === "string" ? err : JSON.stringify(err)))
        ...
        <div className='flex items-start justify-between'>
          <div>
            ...
            <p className={aiInvoiceModalStyles.description}>
              Paste any text that contains invoice details (Client, Item, Quantity, Prices) and we will attempt to extract an invoice
            </p>
          </div>
